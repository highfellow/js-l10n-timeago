...
requirejs(["timeago", "l10n", "l10n-browser"], function(timeago, l10n, l10nBrowser) {
  $(function() {
    ...
    function renderLocale() {
      ...
      table.append("<thead><tr><th>" + l('unit') + "</th><th>" + l('unitMinutes') + "</th><th>" + l('now') + "</th><th>+ 1</th><th>+ 2</th><th>" + l('next') + " -1.5</th><th>" + l('next') + " -0.5</th></tr><thead>");
      ...
      while (unit < l10nUnits.length) {
        ...
        rowStr += '</td><td>' + makeTimeElt(l10nUnit.minutes) + '</td>';
        rowStr += '<td>' + makeTimeElt(l10nUnit.minutes * 2) + '</td>';
